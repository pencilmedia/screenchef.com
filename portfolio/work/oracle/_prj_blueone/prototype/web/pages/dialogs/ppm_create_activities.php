...
?>
	...
	<div id="content" class="content">
		...
		<fieldset class="dynamic first_fieldset">
			...
			<dt class="required"><span>*</span><label for="first_field" title="Type is required">Type:</label></dt>
				<dd>
		...
		<fieldset id="ui_toggle_01" class="dynamic with_bottom_margin">
			<dl class="side_by_side">
				...
				<dd>
					<input type="text" id="ui_control_id_45e4a4021e4330.56117382" class="long_width" />
				</dd>
				<dt><label for="ui_control_id_45e74bf4214bc5.99806252" class="_error">Description:</label></dt>
				<dd class="large_textbox">
					<textarea id="ui_control_id_45e74bf4214bc5.99806252" class="long_width"></textarea>
				</dd>
		...
		<fieldset id="ui_toggle_02" class="last_set">
			...
			<dl class="side_by_side with_top_margin with_bottom_margin">
				...
				<dd>
					...
					<a href="#" ui_control_id_45e4a674b011c3.29158967 class="button"><span><em class="iconic calendar">&nbsp;</em></span></a>
				</dd>
				<dt id="ui_duration_dt" class="required" title="Duration is a required field"><span>*</span><label for="ui_duration">Duration:</label></dt>
				<dd>
				...
				<dd>
					...
					<a href="#" ui_control_id_45e4a674b018d2.52502575 class="button"><span><em class="iconic calendar">&nbsp;</em></span></a>
				</dd>
			</dl>
			<dl class="side_by_side">
