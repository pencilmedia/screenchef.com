<? 
	...
	$ui = new AgileUIBlocks("Reset User Account","","action_dialogs.js","class|action_dialog");
	$controls = new AgileUIControls();
?>
	<div id="header" class="header">
		<?
		$ui->addHeader("action_dialog","Reset User Account","User &bull; user1","","Save","Cancel");
		$ui->addMessage("info","Enter the new password twice and click save to reset the user's password.");
		?>
	</div>
	...
	<form id="form_dialogs" action="">
		<fieldset class="dynamic">
			<dl class="side_by_side">
				...
				<dt class="required" title="Password is required"><span>*</span><label for="confirm_password">Confirm Password:</label></dt>
				<dd>
