	...
	<div id="content" class="content">
	  <form id="form_dialogs" action="">
		<fieldset class="dynamic">
			...
			<dt class="required"><label for="ui_control_id_45ff14b1155dc0.25480277">Number:</label></dt>
			<dd>
				...
				<a href="#" id="ui_control_id_45ff14b11565e1.97469082" class="button icon auto_number" onclick="increment('ui_control_id_45ff14b1155dc0.25480277');return false;">&nbsp;</a>
			</dd>
		...
		<fieldset id="ui_toggle_03">
			...
			<dl class="side_by_side with_top_margin">
				...
				<dd>
					...
					<a href="#" class="button icon calendar">&nbsp;</a>
				</dd>
