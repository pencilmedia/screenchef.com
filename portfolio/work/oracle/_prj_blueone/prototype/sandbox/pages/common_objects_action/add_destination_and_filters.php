...
<link rel="stylesheet" type="text/css" href="global/css/multi_list.css" />
	...
	<link rel="stylesheet" type="text/css" href="create_new_activities.php.css" />	<script type="text/javascript" src="global/js/jquery/jquery.js"></script>
	...
	<title>Add Destination and Filters</title>
</head>
        ...
        *************************************-->	
        <div class="header_wrapper">
            <div class="column_one">
                <h2>Add Destinations and Filters to Transfter Orders</h2>
            </div>		
        </div>
        <!--************************************
            MESSAGES
