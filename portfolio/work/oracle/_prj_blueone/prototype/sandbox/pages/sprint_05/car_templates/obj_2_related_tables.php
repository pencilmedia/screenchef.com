...
<div class="scrollTableDiv">
	<table cellpadding="0" cellspacing="0" class="pointer" onclick="goto('xobj_table_preview_pane.php');">
		<tr>
			<td class="handle">&nbsp;</td>
			<td class="w15">&nbsp;</td>
			<td class="resize">&nbsp;</td>
...
<div class="view_controls">
	<h4>Table Title</h4>
	<p><label>View:</label>
		<select name="" class="disabled" disabled="disabled">
			<option value="">All Content</option>
...
<div class="table_actions">			
	<div class="column_one no_width">
		<p>
			<a href="#" class="button disabled"><span>Add</span></a>
			<a href="#" class="button disabled"><span>Remove</span></a>
			<a href="#" class="button disabled"><span>Multi-Level<em class="dropdown">&nbsp;</em></span></a>
			<a href="#" class="button disabled"><span>Go-To</span></a>
		</p>
	</div>			
	<div class="column_three">
		<p>
			<a href="#" class="button disabled"><span>Save</span></a>
			<a href="#" class="button disabled"><span>Cancel</span></a>
		</p>
	</div>
</div>
<!--************************************
...
<div class="empty_rows">
	<table cellpadding="0" cellspacing="0">
		<tr>
			<td class="handle">&nbsp;</td>
			<td class="empty_table_row">Select a row above to display details.</td>
		</tr>
	</table>
