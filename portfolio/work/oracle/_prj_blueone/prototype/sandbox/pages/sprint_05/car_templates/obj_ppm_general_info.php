<div id="Header" class="header">
    ...
    *************************************-->
    <div class="page_controls">
        <p class="button_controls"><a href="#" class="button" onclick="agile.ux.xhr.get('car_content','pages/sprint_05/car_templates/obj_ppm_general_info_edit.php','ppm_gen_info_init()')"><span>Edit</span></a></p>
    </div>
</div>
<div id="PaneContent">
    <div class="ObjectFull">
        <div class="container obj_form">
            ...
            <p style="margin-bottom: 10px;">556 days of fixed schedule required &bull; 21% complete</p>
            <!--************************************
                TABLE
            *************************************-->
            <table cellpadding="0" cellspacing="0" class="grid">
                <thead>
                    <tr>
                        <th colspan="4">&nbsp;</th>
                        <th colspan="3" class="center_text">Variance in Work Days</th>
                        <th colspan="3" class="center_text">Variance in Calendar Days</th>
                    </tr>
                    <tr>
                        <th width="10%">&nbsp;</th>
