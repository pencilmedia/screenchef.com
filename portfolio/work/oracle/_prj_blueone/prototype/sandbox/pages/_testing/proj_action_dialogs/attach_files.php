...
<head>
	...
	<script type="text/javascript" src="attach_files.php.js"></script>
	<title>Attach Files to Objects</title>
</head>
<body class="action_dialog wizard idd">
	<div id="wrapper_action_dialog_header" class="header rfq">
        <div class="header_wrapper">
            <div class="column_one">
                <h2 id="header_title">Attach Files to Objects</h2>
		...
		<form id="form1" name="form1" action="#">
            ...
            <div id="step_1" class="step">
				<fieldset id="list_selector_01" class="input_lists three_columns_checkbox">
                	<legend>Content to Attach:</legend>
                    <dl class="side_by_side_mixed with_top_margin">
                        <dt>File Folder Version:</dt>
						<dd>
							<select name="list_selector_01" id="selector_01" tabindex="16" class="merdium_width">
