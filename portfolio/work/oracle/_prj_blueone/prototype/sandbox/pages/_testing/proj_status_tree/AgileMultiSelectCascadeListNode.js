 ...
 */
YAHOO.widget.AgileMultiSelectCascadeListNode = function(oData, oParent, expanded, hasIcon) {
    if (oData) { 
...
YAHOO.extend(YAHOO.widget.AgileMultiSelectCascadeListNode, YAHOO.widget.Node, {
	/* ------------------------------------------------------------------------------------
		MEMBER VARIABLES
	------------------------------------------------------------------------------------ */
	/*
	...
	*/
    ...
    initContent: function(oData, hasIcon) { 
		...
		if (oData.iconClass) {
			this._iconClass = oData.iconClass;
		}
		
		// Handle node status
		if (oData.status) {
			this._status = oData.status;
		}
    ...
    getNodeHtml: function() { 
		...
		sb[sb.length] = '<div class="treeNodeStatus ' + this._status + '">&nbsp;</div>';
