var wizard = 
{
	...
	showStep: function(stepNumber)
	{
		...
		{
			case 1:
				var title = 'Schedule Report';
				var message = 'Select the report layout and output type. You can run this report now or set it to run on a schedule.';
			...
			case 2:
				var title = 'Step Two';
				var message = ' You can specify to run this report once, or on a recurring basis. Additionally, you can select who you would like to have access to this report by adding them to the share list.';
				$(".table_actions").hide();
				$('.view_controls').hide();
