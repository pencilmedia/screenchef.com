...
<head>
	...
	<script type="text/javascript" src="replace_attachment.php.js"></script>
	<title>Replace Attachement</title>
	<style type="text/css">
		h4.toggler
		{
	...
	<div id="wrapper_action_dialog_header" class="header rfq">
        <div class="header_wrapper">
            <div class="column_one">
                <h2 id="header_title">Replace Attachment</h2>
                <p>File Folder &bull; Folder 1234</p>
            </div>		
        </div>
        <div id="wizard_steps" class="wizard_steps">
            <h2 id="wStepTitle">Select File to Replace</h2>
        </div>
	...
	<div id="wrapper_action_dialog_content" class="content">
        ...
        <legend>To Replace</legend>
            ...
            <dl class="side_by_side_text">
              <dt>Attachment:</dt>
              <dd>xxxxx xxxxxxxx xxxxxxxxxxxxx</dd>
        ...
        <legend>Replace With</legend>
            <dl class="side_by_side_mixed with_top_margin">
                ...
                <dt title="Single Select Search"><label for="textbox1" ></label></dt>
                <dd>
                    <div id="sss" class="list_control medium_width">
                        <input type="text" id="textbox1" class="textbox1 disabled" />
                    </div>
