...
<head>
	...
	<script type="text/javascript" src="replace_attached_version.php.js"></script>
	<title>Replace Attached Version</title>
</head>
<body class="action_dialog wizard idd">
	<div id="wrapper_action_dialog_header" class="header rfq">
        <div class="header_wrapper">
            <div class="column_one">
                <h2 id="header_title">Replace Attached Version</h2>
