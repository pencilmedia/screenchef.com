    ...
    <div id="ux_palette" class="ux_palette">
        <div id="ux_palette_top" class="ux_palette_top">
            <div id="ux_palette_header" class="ux_palette_header">
              ...
              <h4 id="ux_palette_title" class="ux_palette_title">Program Issues</h4>
        ...
        <div id="ux_palette_main" class="ux_palette_main">
			...
			<fieldset class="dynamic">
				<dl class="side_by_side_mixed with_top_margin">
					...
					<!-- Required Select -->
					<dt style="width:20%"><label for="first_field">Type (Discussion) Equal To:</label></dt>
					<dd>
						<select id="first_field" class="long_width">
							<option value="" selected="selected">Issues</option>
						</select>
					</dd>
