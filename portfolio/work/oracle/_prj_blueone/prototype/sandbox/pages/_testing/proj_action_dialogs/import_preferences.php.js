var wizard = 
{
	...
	*********************************************/
	...
	//
	step1Title : 'Preference Settings',
	...
	*********************************************/
	...
	{
		wizard.showStep(1);
		$('#tab_01').addClass('selected');
		$('.palette_tabs a').bind('click', wizard.tabs_onclick);
	},
	
	tabs_onclick : function()
	{
		$('.palette_tabs a').removeClass('selected');
		$('.step').hide();
		switch( this.id )
		{
			case 'tab_01':
