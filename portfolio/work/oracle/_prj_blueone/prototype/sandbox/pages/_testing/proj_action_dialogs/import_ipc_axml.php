	...
	<div id="wrapper_action_dialog_header" class="header rfq">
        <div class="header_wrapper">
            <div class="column_one">
                <h2 id="header_title">Import IPC XML</h2>
                <p>Declaration &bull; MD00163</p>
            </div>		
        </div>
        <div id="page_message" class="message info">
            <p id="step_message">Select a file to import. Only Agile IPC XML (xml) file type is supported.  You may optionally attach a corresponding PDF file.</p>
		...
		<form id="form1" name="form1" action="#">
            ...
            <div id="step_1" class="step">
				<dl class="side_by_side_mixed">
                    ...
                    <dt><label for="req_sel_00">Attach PDF:</label></dt>
                    <dd>
                        <input id="file_selector" type="file" class="file_selector" size="50" /> 
                        <span class="error_msg hidden">Error message...</span>
                    </dd>
