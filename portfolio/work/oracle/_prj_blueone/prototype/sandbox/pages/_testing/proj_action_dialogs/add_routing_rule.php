	...
	<div id="wrapper_action_dialog_header" class="header">
        ...
        *************************************-->
        <div id="page_message" class="message info">
            <p>Select a contact user and geography that the contact is responsible for.</p>
        </div>
	</div>
	...
	<div id="wrapper_action_dialog_content" class="content">
        ...
        <fieldset class="dynamic">
            <dl class="side_by_side_mixed with_bottom_margin">
                ...
                <!-- Required Select -->
                <dt class="required"><label for="req_sel_00">Contact:</label></dt>
                <dd>
                    <select id="req_sel_00" class="long_width">
						<option>John Smith</option>
						<option>Hector Alvarez</option>
                ...
                <!-- MULTI SELECT LIST -->
                <dt class="required"><label for="msl_00">Geography:</label></dt>
                <dd>
                    ...
                    <a href="#" id="cmd_msl_00" class="button"><span><em class="iconic action_list_tree">&nbsp;</em>&nbsp;</span></a>
                </dd>                
...
<div id="wrapper_action_dialog_footer" class="footer">
    <div class="column_three">
        <a href="#" id="cmdAdd" class="button"><span><em class="save_dialog">&nbsp;</em>Add</span></a> 
