...
<body class="action_dialog wizard">
	<div id="wrapper_action_dialog_header" class="header rfq">
        <div class="header_wrapper">
            <div class="column_one">
                <h2 id="header_title">Export Responses</h2>
                <p>Export</p>
            </div>		
        </div>
		...
		<form id="form1" name="form1" action="#">
            ...
            <div id="step_1" class="step">
				<dl class="side_by_side_mixed">
                    <dt class="required"><label for="req_sel_00">Export File:</label></dt>
                    <dd>
                    ...
                    <dd class="side_by_side_radio">
                         ...
                         <input type="radio" class="form_selectors" name="for_location" id="sel2"/> <label for="sel2">Configure</label>
                	</dd>
                </dl>
            </div>
		</form>
    ...
    <div id="wrapper_action_dialog_footer" class="footer">
    	...
    	<div class="column_three">
	        ...
	        <a href="#" id="cmdClose" class="button btn_next_group"><span>Validate</span></a> 
	    </div>
	</div>
</body>
</html>
