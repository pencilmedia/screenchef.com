YAHOO.widget.AgileCascadeListTree = function(id) {
    if (id) { 
		this.init(id);
		this.initCustom(id);
	}
...
YAHOO.extend(YAHOO.widget.AgileCascadeListTree, YAHOO.widget.TreeView, {
	/* ------------------------------------------------------------------------------------
		MEMBER VARIABLES
	------------------------------------------------------------------------------------ */
...
YAHOO.widget.AgileSingleSelectCascadeListTree = function(id) {
    if (id) { 
		this.init(id);
		this.initCustom(id);
	}
...
YAHOO.extend(YAHOO.widget.AgileSingleSelectCascadeListTree, YAHOO.widget.AgileCascadeListTree, {
