...
function init()
{
	...
	prepOptions();
	toggleContent();
	jQuery('#ux_palette').css({width:600,height:370,top:50,left:50});
...
function doResize()
{
	// This stuff is smoke and mirrors and correct calculations should be applied.
	// - Anthony.
	jQuery('.object_messages').css('height', jQuery('#ux_palette').height() - 280 );
}
