...
<div id="parts" class="save_bom_as" dojoType="LayoutContainer" layoutChildPriority='top-bottom' style="width: 100%; height: 100%;">
	...
	<div dojoType="ContentPane" layoutAlign="client">
		<a onclick="var docPane = dojo.widget.getWidgetById('main'); docPane.setUrl('./content/main/parts/save_bom_as/screen_part_save_bom_as_14.php');"><img src="agi_konablue_create_bom_change_redlines.png" /></a>
	</div>
