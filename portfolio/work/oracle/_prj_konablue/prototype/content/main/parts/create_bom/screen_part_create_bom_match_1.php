...
<div id="parts" class="create_bom" dojoType="LayoutContainer" layoutChildPriority='top-bottom' style="width: 100%; height: 100%;">
	...
	<div dojoType="SplitContainer" orientation="horizontal" sizerWidth="5" activeSizing="0" layoutAlign="client">
		...
		<div dojoType="LayoutContainer" layoutChildPriority='top-bottom' sizeShare="30" sizeMin="295" layoutAlign="client">
			...
			<div dojoType="ContentPane" sizeShare="0" layoutAlign="top" style="height: 65px; width: 100%;" class="header_wrap">
				<? include_once($PART_PATH . "/create_bom/mod_part_create_bom_tabs_2.php"); ?>
			</div>
			
			<div dojoType="LayoutContainer" sizeShare="100" layoutAlign="client">
			
				<div dojoType="ContentPane" sizeShare="50" sizeMin="200">
					<? include_once($PART_PATH . "/create_bom/mod_part_create_bom_match_parts.php"); ?>
				</div>
				
				<div dojoType="ContentPane" sizeShare="0" sizeMin="400" style="height: 29px; width: 100%">
					<? include_once($PART_PATH . "/create_bom/mod_part_create_bom_input_blank.php"); ?>
				</div>
				
				<div dojoType="ContentPane" sizeShare="100" sizeMin="200">
					<? include_once($PART_PATH . "/create_bom/mod_part_create_bom_match_tree.php"); ?>
				</div>
			...
			<div dojoType="ContentPane" sizeShare="0" layoutAlign="bottom" style="height: 105px; width: 100%;">
				<? include_once($PART_PATH . "/create_bom/mod_part_create_bom_match_confirmation.php"); ?>
			</div>
