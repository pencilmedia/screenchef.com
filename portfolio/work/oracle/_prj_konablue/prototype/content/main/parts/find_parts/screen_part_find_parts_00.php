<?
	...
	$header_text_0 = $strings['str17'];
	$header_text_1 = $strings['str18'];
...
<div id="parts" class="find_parts" dojoType="LayoutContainer" layoutChildPriority='top-bottom' style="width: 100%; height: 100%;">
	...
	<div dojoType="ContentPane" sizeShare="0" layoutAlign="top" style="height: 30px; width: 100%">
		<? include_once($PART_PATH . "/find_parts/mod_part_find_parts_status_text_0.php"); ?>
	</div>
	
	<div dojoType="LayoutContainer" layoutChildPriority='top-bottom'  sizeShare="100" layoutAlign="client">
		<? include_once($PART_PATH . "/find_parts/mod_part_find_parts_table_find_empty.php"); ?>
	</div>
	
	<div dojoType="ContentPane" sizeShare="0" layoutAlign="bottom" style="height: 31px; width: 100%;">
		<? include_once($PART_PATH . "/find_parts/mod_part_find_parts_action_2.php"); ?>
	</div>
