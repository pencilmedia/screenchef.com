	...
	<div dojoType="SplitContainer" orientation="horizontal" sizerWidth="5" activeSizing="0" layoutAlign="client">
			...
			<div dojoType="SplitContainer" orientation="vertical" sizerWidth="5" activeSizing="0" layoutAlign="client">
				...
				<div dojoType="LayoutContainer" layoutChildPriority='top-bottom' sizeShare="60" sizeMin="300">
					...
					<div dojoType="LayoutContainer" sizeShare="100" sizeMin="100" layoutAlign="client">
						...
						<div dojoType="LayoutContainer" layoutChildPriority='left-right'>
							...
							<div dojoType="ContentPane" sizeShare="50" layoutAlign="left">
								<? include_once($DOC_PATH . "/appr_chng/mod_doc_appr_chng_view_doc_stats_edit.php"); ?>
							</div>
					...
					<div dojoType="ContentPane" sizeShare="0" layoutAlign="bottom" style="height: 31px; width: 100%;">
						<? include_once($DOC_PATH . "/appr_chng/mod_doc_appr_chng_view_doc_action_stats_1.php"); ?>
					</div>
				
				</div>
				
				<div dojoType="LayoutContainer" layoutChildPriority='top-bottom' sizeShare="40" sizeMin="100">
					<? include_once($DOC_PATH . "/appr_chng/mod_doc_appr_chng_view_doc_table.php"); ?>
				</div>
				
			</div>
			
			<div dojoType="ContentPane" sizeShare="0" layoutAlign="bottom" style="height: 31px; width: 100%;">
				<? include_once($DOC_PATH . "/appr_chng/mod_doc_appr_chng_view_doc_action_view_0.php"); ?>
			</div>
		...
		<div dojoType="LayoutContainer" layoutChildPriority='top-bottom' sizeShare="20" sizeMin="200" layoutAlign="client">
			...
			<div dojoType="LayoutContainer" sizeShare="25">
				<? include_once($DOC_PATH . "/appr_chng/mod_doc_appr_chng_view_doc_switcher_1.php"); ?>
			</div>
			
			<div dojoType="LayoutContainer" sizeShare="25">
				<? include_once($DOC_PATH . "/appr_chng/mod_doc_appr_chng_view_doc_switcher_2.php"); ?>
			</div>
			
			<div dojoType="LayoutContainer" sizeShare="25">
				<? include_once($DOC_PATH . "/appr_chng/mod_doc_appr_chng_view_doc_switcher_3.php"); ?>
			</div>
			
			<div dojoType="LayoutContainer" sizeShare="25">
				<? include_once($DOC_PATH . "/appr_chng/mod_doc_appr_chng_view_doc_switcher_4.php"); ?>
			</div>
			
			<div dojoType="ContentPane" sizeShare="0" layoutAlign="bottom" style="height: 31px; width: 100%;">
				<? include_once($DOC_PATH . "/appr_chng/mod_doc_appr_chng_view_doc_action_view_1.php"); ?>
			</div>
