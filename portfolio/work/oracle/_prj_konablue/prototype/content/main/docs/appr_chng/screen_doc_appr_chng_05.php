<?
	...
	$status_text = "There are <em>2 DOCUMENTS</em> with changes that require your approval.";
?>
...
<div id="docs" class="appr_chng" dojoType="LayoutContainer" layoutChildPriority='top-bottom' style="height: 100%; width: 100%;">
	...
	<div dojoType="LayoutContainer" sizeShare="0" layoutAlign="client">
		<? include_once($DOC_PATH . "/appr_chng/mod_doc_appr_chng_table_list_complete.php"); ?>
	</div>
	...
	<div dojoType="ContentPane" sizeShare="0" layoutAlign="bottom">
		<? include_once($DOC_PATH . "/appr_chng/mod_doc_appr_chng_confirmation.php"); ?>
	</div>
