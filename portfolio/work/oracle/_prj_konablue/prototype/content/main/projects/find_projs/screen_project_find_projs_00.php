<?
	...
	$header_text_0 = $strings['str50'];
	$header_text_1 = $strings['str51'];
...
<div id="projects" class="projects_startpage" dojoType="LayoutContainer" layoutChildPriority='top-bottom' style="width: 100%; height: 100%;">
	...
	<div dojoType="ContentPane" sizeShare="0" layoutAlign="top" style="height: 30px; width: 100%">
		<? include_once($PROJ_PATH . "/find_projs/mod_project_find_projs_status_text_0.php"); ?>
	</div>
	
	<div dojoType="LayoutContainer" layoutChildPriority='top-bottom'  sizeShare="100" layoutAlign="client">
		<? include_once($PROJ_PATH . "/find_projs/mod_project_find_projs_table_find_empty.php"); ?>
	</div>
