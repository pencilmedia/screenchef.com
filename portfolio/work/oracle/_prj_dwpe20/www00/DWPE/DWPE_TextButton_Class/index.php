<?php
		session_start();
		$component_title="DWPE TextButton Class";
		$component_key="DWPE_TextButton_Class";
		$owner="Roy Selig";
		$specs=array();
...
<body>
	...
	<div id="test-plan">
		...
		<h3>Text Button Beta Testing: 6/23</h3>
		...
		<li>Test Icon and Command Selection Secondary Dialogs
			...
			<ul>
				...
				<li>From the DWPE2 Insert Bar, click the toolbar icon <img src="../DWPE_Extension/images/dwpe-icon-toolbar.png" valign="middle"> and select the "Text Button" menu item.  The Text Button dialog should appear.</li>
		...
		<h3>Text Button Beta Testing:6/9</h3>
		
		<p><h4>Attributes tab...</h4>
		<img src="../DWPE_Extension/images/dwpe-dialog-textbutton.png" title='Dreamweaver Text Button Dialog: Attributes Tab'>
		<p>&nbsp;</p>
		</p>
		...
		<li>Test Dialog Output & Runtime
			...
			<ul>
				<li>Create a new test page.</li>
				<li>From the DWPE2 Insert Bar, click the toolbar icon <img src="../DWPE_Extension/images/dwpe-icon-toolbar.png" valign="middle"> and select the "Text Button" menu item.  The Text Button dialog should appear.</li>
				<li>On the attributes tab enter values for label,tooltip and command. Click OK.</li>
				<li>In design mode a component placeholder will appear at the insertion point. </li>
				<li>Preview the page in Firefox.  Does the control render correctly? When operating the up/down buttons, does the control behave correctly?</li>
				<li>Note that a Text Button can appear inside a toolbar, or outside of one.  When appearing outside a toolbar it is considered a Command Button. That is what you are testing here.  We will test Text Button's inside toolbars during the toolbar test.</li>
			</ul>
		</li>
		...
		<h3>Text Button Alpha Testing</h3>
               ...
               <table cellpadding='0' cellspacing='0' style="border:1px solid #999999;background:#e0e0e0; width:100%;">
				...
				<div style="padding:20px 0px">
					...
					<script type="text/javascript">
						...
						function insert()
						{
							$("#scratchpad").val( DWPE_ButtonFactory.generateTextButtonMarkup( collectArguments() ) );
						}
					</script>
				</div>
