<?php
		session_start();
		$component_title="DWPE IconicButton Class";
		$component_key="DWPE_IconicButton_Class";
...
<body>
	...
	<div id="test-plan">
		...
		<h3>Iconic Button Beta Testing: 6/23</h3>
		...
		<li>Test Icon and Command Selection Secondary Dialogs
			...
			<ul>
				...
				<li>From the DWPE2 Insert Bar, click the toolbar icon <img src="../DWPE_Extension/images/dwpe-icon-toolbar.png" valign="middle"> and select the "Iconic Button" menu item.  The Iconic Button dialog should appear.</li>
		...
		<h3>Iconic Button Beta Testing: 6/9</h3>
		
		<p><h4>Attributes tab...</h4>
		<img src="../DWPE_Extension/images/dwpe-dialog-iconicbutton.png" title='Dreamweaver Iconic Button Dialog: Attributes Tab'>
		<p>&nbsp;</p>
		</p>
		...
		<li>Test Dialog Output & Runtime
			...
			<ul>
				...
				<li>In design mode a component placeholder will appear at the insertion point. </li>
				<li>Preview the page in Firefox.  Does the control render correctly? Does the control behave correctly?</li>
				<li>Note that an Iconic Button can appear inside a toolbar, or outside of one.  When appearing outside a toolbar it is considered a Command Button. That is what you are testing here.  We will test Iconic Buttons inside toolbars during the toolbar test.</li>
               ...
               <table cellpadding='0' cellspacing='0' style="border:1px solid #999999;background:#e0e0e0; width:100%;">
				...
				<div style="padding:20px 0px">
					...
					<script type="text/javascript">
						...
						function insert()
						{
							$("#scratchpad").val( DWPE_ButtonFactory.generateIconicButtonMarkup( collectArguments() ) );
						}
					</script>
				</div>
