...
<head>
  ...
  <link rel="stylesheet" type="text/css" <?php echo 'href="' . $ROOT . 'assets/css/data_upload.css"' ?>></head>
<body>
  <!-- Navbar -->
  <?php include("../../../vshell/navbar.inc.php"); ?>
  <?php include("../../../vshell/navbar_menus.inc.php"); ?>
  <main class="cloudshellWork">
    <?php include("dictionary.inc.php"); ?>
    <?php include("rt_panel.inc.php"); ?>
    <!-- //////////////// -->
    <!-- MODAL TOURS -->
    ...
    <script type="text/javascript" <?php echo 'src="' . $ROOT . 'workspaces/data/dictionary/dictionary.js"' ?>></script>
</body>
</html>