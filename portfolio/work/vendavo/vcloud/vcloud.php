...
<body class="secondary portfolio">
    ...
    <main>
        ...
        <article class="screenshots">
            <p>
                <a href="#1">Final Screenshots</a> | <a href="#2">Customer Accounts Screenshots</a> | <a href="#3">Users Screenshots</a>
            </p>
            <section>
                <h2 id="1">Final Screenshots</h2>
                <?php 
                    $dirname = "5_vcloud_screens/";
            ...
            <section>
                <h2 id="2">Customer Accounts Screenshots</h2>
                <?php 
                    $dirname = "5_vcloud_screens/vpa_customer_acct/";
                    $images = glob($dirname."*.png");
                    foreach($images as $image) {
                    echo '<p><img src="'.$image.'" /></p>';
                    }
            ...
            <section>
                <h2 id="3">Users Screenshots</h2>
                <?php 
                    $dirname = "5_vcloud_screens/vpa_users/";
                    $images = glob($dirname."*.png");
                    foreach($images as $image) {
                    echo '<p><img src="'.$image.'" /></p>';
                    }
