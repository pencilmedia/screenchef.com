 ...
 components = {
     ...
     modalWizard: function() {
         ...
         $('.pd-modal .modal-footer .btn-next').on('click', function() {
             stepName = $(this).data("cycle"); // next button data-cycle
        ...
        switch (whichStep) { 
            case 'step-1': 
             ...
             var currentStep = $(".step[data-step=" + stepName + "]"); // create next step
             ...
             $(".step").hide();
                ...
                $(".btn-back").toggle();
                setupNextStep = currentStep.next().data("step"); // get data-step of the next step
                $(".modal-footer .btn").attr("data-cycle", setupNextStep); // change data-cycle value on next button to the next screen step
            ...
            case 'step-2': 
             ...
             $(".step").hide();
                ...
                stepName = '';
                alert(stepName);
                stepName = $('.modal-footer .btn-next').data("cycle"); // next button data-cycle
        ...
        //     currentStep.toggle().next().data("step"); // display the next step




             
         //    components.modalWizardStepper(currentStep); // next step
         });
     },
     // Wizard Stepper
     ///////////////
     modalWizardStepper: function(currentStep) {
